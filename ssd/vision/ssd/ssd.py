...
logger = logging.getLogger('demo.ssd')
...
class SSD(nn.Module):
    def __init__(self,
        ...
        logger.debug(f"source_layer_add_ons: {self.source_layer_add_ons}")
